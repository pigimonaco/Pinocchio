...
int write_product(int flag, int ThisGrid)
{
  ...
  while ( (cube=(PRODFLOAT*)malloc(cubesize*sizeof(PRODFLOAT))) == 0x0 )
    {
      if(xsize > 2)
	xsize *=  0.8;
      else if(ysize > 2)
...
/* 	      for (iy=0; iy<MyGrids[MyGrid].GSglobal[_y_]; iy++) */
/* 		for (ix=0; ix<MyGrids[MyGrid].GSglobal[_x_]; ix++) */
/* 		  plane[ix + iy*MyGrids[MyGrid].GSglobal[_x_]]=products[ix + (MyGrids[MyGrid].GSlocal[_x_]) * (iy + local_z * MyGrids[MyGrid].GSlocal[_y_])].Vel[0]; */
/* 	      break; */
/* 	    case 2: */
/* 	      for (iy=0; iy<MyGrids[MyGrid].GSglobal[_y_]; iy++) */
/* 		for (ix=0; ix<MyGrids[MyGrid].GSglobal[_x_]; ix++) */
/* 		  plane[ix + iy*MyGrids[MyGrid].GSglobal[_x_]]=products[ix + (MyGrids[MyGrid].GSlocal[_x_]) * (iy + local_z * MyGrids[MyGrid].GSlocal[_y_])].Vel[1]; */
/* 	      break; */
/* 	    case 3: */
/* 	      for (iy=0; iy<MyGrids[MyGrid].GSglobal[_y_]; iy++) */
/* 		for (ix=0; ix<MyGrids[MyGrid].GSglobal[_x_]; ix++) */
/* 		  plane[ix + iy*MyGrids[MyGrid].GSglobal[_x_]]=products[ix + (MyGrids[MyGrid].GSlocal[_x_]) * (iy + local_z * MyGrids[MyGrid].GSlocal[_y_])].Vel[2]; */
/* 	      break; */
/* 	    case 4: */
/* 	      for (iy=0; iy<MyGrids[MyGrid].GSglobal[_y_]; iy++) */
/* 		for (ix=0; ix<MyGrids[MyGrid].GSglobal[_x_]; ix++) */
/* 		  plane[ix + iy*MyGrids[MyGrid].GSglobal[_x_]]=(PRODFLOAT)products[ix + (MyGrids[MyGrid].GSlocal[_x_]) * (iy + local_z * MyGrids[MyGrid].GSlocal[_y_])].Rmax; */
/* 	      break; */
/* #ifdef TWO_LPT */
/* 	    case 5: */
/* 	      for (iy=0; iy<MyGrids[MyGrid].GSglobal[_y_]; iy++) */
/* 		for (ix=0; ix<MyGrids[MyGrid].GSglobal[_x_]; ix++) */
/* 		  plane[ix + iy*MyGrids[MyGrid].GSglobal[_x_]]=products[ix + (MyGrids[MyGrid].GSlocal[_x_]) * (iy + local_z * MyGrids[MyGrid].GSlocal[_y_])].Vel_2LPT[0]; */
/* 	      break; */
/* 	    case 6: */
/* 	      for (iy=0; iy<MyGrids[MyGrid].GSglobal[_y_]; iy++) */
/* 		for (ix=0; ix<MyGrids[MyGrid].GSglobal[_x_]; ix++) */
/* 		  plane[ix + iy*MyGrids[MyGrid].GSglobal[_x_]]=products[ix + (MyGrids[MyGrid].GSlocal[_x_]) * (iy + local_z * MyGrids[MyGrid].GSlocal[_y_])].Vel_2LPT[1]; */
/* 	      break; */
/* 	    case 7: */
/* 	      for (iy=0; iy<MyGrids[MyGrid].GSglobal[_y_]; iy++) */
/* 		for (ix=0; ix<MyGrids[MyGrid].GSglobal[_x_]; ix++) */
/* 		  plane[ix + iy*MyGrids[MyGrid].GSglobal[_x_]]=products[ix + (MyGrids[MyGrid].GSlocal[_x_]) * (iy + local_z * MyGrids[MyGrid].GSlocal[_y_])].Vel_2LPT[2]; */
/* 	      break; */
/* #ifdef THREE_LPT */
/* 	    case 8: */
/* 	      for (iy=0; iy<MyGrids[MyGrid].GSglobal[_y_]; iy++) */
/* 		for (ix=0; ix<MyGrids[MyGrid].GSglobal[_x_]; ix++) */
/* 		  plane[ix + iy*MyGrids[MyGrid].GSglobal[_x_]]=products[ix + (MyGrids[MyGrid].GSlocal[_x_]) * (iy + local_z * MyGrids[MyGrid].GSlocal[_y_])].Vel_3LPT_1[0]; */
/* 	      break; */
/* 	    case 9: */
/* 	      for (iy=0; iy<MyGrids[MyGrid].GSglobal[_y_]; iy++) */
/* 		for (ix=0; ix<MyGrids[MyGrid].GSglobal[_x_]; ix++) */
/* 		  plane[ix + iy*MyGrids[MyGrid].GSglobal[_x_]]=products[ix + (MyGrids[MyGrid].GSlocal[_x_]) * (iy + local_z * MyGrids[MyGrid].GSlocal[_y_])].Vel_3LPT_1[1]; */
/* 	      break; */
/* 	    case 10: */
/* 	      for (iy=0; iy<MyGrids[MyGrid].GSglobal[_y_]; iy++) */
/* 		for (ix=0; ix<MyGrids[MyGrid].GSglobal[_x_]; ix++) */
/* 		  plane[ix + iy*MyGrids[MyGrid].GSglobal[_x_]]=products[ix + (MyGrids[MyGrid].GSlocal[_x_]) * (iy + local_z * MyGrids[MyGrid].GSlocal[_y_])].Vel_3LPT_1[2]; */
/* 	      break; */
/* 	    case 11: */
/* 	      for (iy=0; iy<MyGrids[MyGrid].GSglobal[_y_]; iy++) */
/* 		for (ix=0; ix<MyGrids[MyGrid].GSglobal[_x_]; ix++) */
/* 		  plane[ix + iy*MyGrids[MyGrid].GSglobal[_x_]]=products[ix + (MyGrids[MyGrid].GSlocal[_x_]) * (iy + local_z * MyGrids[MyGrid].GSlocal[_y_])].Vel_3LPT_2[0]; */
/* 	      break; */
/* 	    case 12: */
/* 	      for (iy=0; iy<MyGrids[MyGrid].GSglobal[_y_]; iy++) */
/* 		for (ix=0; ix<MyGrids[MyGrid].GSglobal[_x_]; ix++) */
/* 		  plane[ix + iy*MyGrids[MyGrid].GSglobal[_x_]]=products[ix + (MyGrids[MyGrid].GSlocal[_x_]) * (iy + local_z * MyGrids[MyGrid].GSlocal[_y_])].Vel_3LPT_2[1]; */
/* 	      break; */
/* 	    case 13: */
/* 	      for (iy=0; iy<MyGrids[MyGrid].GSglobal[_y_]; iy++) */
/* 		for (ix=0; ix<MyGrids[MyGrid].GSglobal[_x_]; ix++) */
/* 		  plane[ix + iy*MyGrids[MyGrid].GSglobal[_x_]]=products[ix + (MyGrids[MyGrid].GSlocal[_x_]) * (iy + local_z * MyGrids[MyGrid].GSlocal[_y_])].Vel_3LPT_2[2]; */
/* 	      break; */
/* #endif */
/* #endif */
/* 	    default: */
