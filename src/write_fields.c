...
int write_product(int flag, char *tag)
{
  ...
  if ( (plane=(float*)malloc(planesize*sizeof(float))) == 0x0 )
    {
...
#else
#ifdef FORTRAN
	  idummy=planesize*sizeof(float);
	  fwrite(&idummy,sizeof(int),1,file);
#endif
	  fwrite(plane,sizeof(float),planesize,file);
#ifdef FORTRAN
	  fwrite(&idummy,sizeof(int),1,file);
#endif
#endif
...
/* #ifdef KEEP_FIELDS */
/* int write_tdep_fields(double z) */
/* { */
/*   if (params.WriteVmax) */
/*     { */
/*       char tag[15]; */
/*       sprinft(tag,"_%6.4f",z); */
/*       if (write_product(14,tag)) */
/* 	return 1; */
/*       if (write_product(15,tag)) */
/* 	return 1; */
/*       if (write_product(16,tag)) */
/* 	return 1; */
/* #ifdef TWO_LPT */
/*       if (write_product(17,tag)) */
/* 	return 1; */
/*       if (write_product(18,tag)) */
/* 	return 1; */
/*       if (write_product(19,tag)) */
/* 	return 1; */
/*     } */
/* #endif */
/*   return 0; */
