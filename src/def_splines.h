...
/* #define SP_SMGROW1    (9+8*NkBINS) */
/* #define SP_SMGROW2    (9+8*NkBINS+Smoothing.Nsmooth) */
/* #define SP_SMGROW31   (9+8*NkBINS+2*Smoothing.Nsmooth) */
/* #define SP_SMGROW32   (9+8*NkBINS+3*Smoothing.Nsmooth) */
/* #define SP_SMFOMEGA1  (9+8*NkBINS+4*Smoothing.Nsmooth) */
/* #define SP_SMFOMEGA2  (9+8*NkBINS+5*Smoothing.Nsmooth) */
/* #define SP_SMFOMEGA31 (9+8*NkBINS+6*Smoothing.Nsmooth) */
/* #define SP_SMFOMEGA32 (9+8*NkBINS+7*Smoothing.Nsmooth) */
